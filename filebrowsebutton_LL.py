...
class FileBrowseButton(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY,
                 ...
                 buttonText="Browse",                                       # Text for button which launches the file dialog
                 toolTip="Type filename or click browse to choose file",    # Help text
                 # following are the values for a file dialog box
                 dialogTitle="Choose a file",                               # Title used in file dialog
                 startDirectory=".",                                        # Default directory for file dialog startup
                 initialValue="",
                 wildcard="*.*",                                            # Wildcard (glob pattern, such as *.*) to use in file dialog
                 style=wx.FD_OPEN,                                          # wx.FD_OPEN or wx.FD_SAVE, indicates type of file dialog to use
                 ...
                 labelWidth=0,                                              # Width of the label
                 name='fileBrowseButton',                                   # object name
                 ):
    ...
    def createDialog(self, parent, id, pos, size, style, name):
        ...
        box.Add(self.textControl, 4, wx.LEFT | wx.CENTER, 2)

        self.browseButton = self.createBrowseButton()
        box.Add(self.browseButton, 1, wx.LEFT | wx.CENTER, 2)
    ...
    def createLabel(self):
        ...
        label = wx.StaticText(self, wx.ID_ANY, self.labelText, style=wx.ALIGN_RIGHT)
        font = label.GetFont()
    ...
    def OnBrowse(self, event=None):
        ...
        dlg = wx.FileDialog(self, message=self.dialogTitle,
    ...
    def SetValue(self, value, callBack=1):
        ...
        self.textControl.SetValue(str(value))
